...
export default class UsernameScene extends Phaser.Scene {
	...
	// }
	create() {
		const usernameConfig = new UsernameConfig(this);
		...
		// this method takes in the x, y, coordinate for the text input box and the configuration object used to create the box.
